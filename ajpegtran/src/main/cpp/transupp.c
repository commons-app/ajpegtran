...
jtransform_prepare_pixelize(j_decompress_ptr srcinfo,
    ...
    }
    {
        ...
        /* Convert negative pix offsets into regular offsets */
        if (info->pix_xoffset_set != JCROP_NEG)
            xoffset = info->pix_xoffset;
        else if (info->pix_width > info->output_width) /* pix extension */
        ...
        else if (info->pix_height > info->output_height) /* pix extension */
